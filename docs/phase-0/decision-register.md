...
| [0003](../adr/0003-tenant-model-and-optional-postgresql-rls.md) | Proposed | [Role graph and policy matrix](evidence/ash-pressure-test.md#authorization-graph-integrity-and-policy-matrix-slice), [trusted routing tests](evidence/trusted-routing.md), [tenant-placement capacity evidence](evidence/tenant-placement-capacity.md), threat model, movement, backup, and restore drills | Which profile passes each tenant's peak, recovery, residency, cost, and isolation targets, and is RLS required as a backstop? |
| [0005](../adr/0005-domain-action-and-state-transition-convention.md) | Proposed | [Named action and stable core JSON:API errors](evidence/ash-pressure-test.md#generated-jsonapi-policy-slice) | Do rate-limited, retryable-dependency, and forced-internal mappings complete the error convention? |
...
| [0014](../adr/0014-primary-api-and-generated-typescript-client.md) | Proposed | [Versioned JSON:API, pagination, errors, idempotency, OpenAPI, and generated-client proof](evidence/ash-pressure-test.md#generated-jsonapi-policy-slice) | Do the remaining error categories pass, and are the bounded page-limit, error, idempotency, and client adapters acceptable to their accountable owners? |
