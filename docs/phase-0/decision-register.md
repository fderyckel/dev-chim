...
| [0005](../adr/0005-domain-action-and-state-transition-convention.md) | Proposed | [Named action and complete proposed JSON:API error taxonomy](evidence/ash-pressure-test.md#stable-public-error-taxonomy-slice) | Do the accountable owners accept the action, transaction, concurrency, and error convention? |
...
| [0014](../adr/0014-primary-api-and-generated-typescript-client.md) | Proposed | [Versioned JSON:API, pagination, complete proposed errors, idempotency, OpenAPI, and generated-client proof](evidence/ash-pressure-test.md#stable-public-error-taxonomy-slice) | Are the bounded page-limit, error/header, idempotency, and client adapters acceptable to their accountable owners? |
